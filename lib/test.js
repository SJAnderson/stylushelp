...
(function() {
  var USAGE, alphabetize, args, argv, async, command, exit, filePath, fs, getFiles, getPreSpaces, log, optimist, opts, path, processData, valid_selectors, value, writeToLine,
  ...
  writeToLine = (function(_this) {
    return function(file, line_str, line_num) {
      ...
      switch (command) {
        case 'simple_lint':
            ...
            for (_i = 0, _len = read_files.length; _i < _len; _i++) {
              ...
              for (line_num = _j = 0, _len1 = data.length; _j < _len1; line_num = ++_j) {
                ...
                if (config.bad_space_check) {
                  ...
                  if ((spaces % 2) !== 0) {
                    addError(config != null ? config.bad_space_check : void 0, line, line_num + 1);
                  }
                }
          ...
          postJsonChecks = function() {
            var arr, att, attribute, attribute_info, check_1, check_2, data, dupe, file, file_name, index, key, line, line_num, lines, pair, stylus_stags, tag, total_tags, _i, _len, _name, _ref, _ref1, _results;
            ...
            for (file_name in data) {
              ...
              for (line_num in file) {
                ...
                _ref = attribute_info.attributes;
          ...
          alphabetizeCheck = function() {
            var infraction, key, return_data, _i, _len, _ref, _results;
            if (config.alphabetize_check) {
              ...
              for (key = _i = 0, _len = _ref.length; _i < _len; key = ++_i) {
                infraction = _ref[key];
                _results.push(addError(config.alphabetize_check, infraction.line, infraction.line_number));
              }
              return _results;
            }
          };
